...
namespace KomplesniBroj
{
    class Program
    {
        ...
        {
            //stvaranje objekta, rezerviranje imena za varijablu:
            ...
            Console.WriteLine("Prije pridruživanja:");
            ...
            //override-anje metode ToString kako bi dobili prikaz idi u klasu
            Console.WriteLine("Nakon pridruživanja:");
            Console.WriteLine($"kbk1 = {kbk1}");
            Console.WriteLine($"kbk2 = {kbk2}");
            Console.WriteLine($"kbs1 = {kbs1}");
            Console.WriteLine($"kbs2 = {kbs2}");
